...
import Navbar from './Navbar'; // Assurez-vous d'importer correctement Navbar
...
const rows = [
    ...
    { id: 2, nom: 'Martin', prenom: 'Marie', role: 'Superviseur', email: 'marie.martin@example.com', entreeService: '02/02/2022', grade: 'Grade B', affectation: 'Service B', localisation: 'Lyon', chefServiceNom:
    'Chef B', chefServicePrenom: 'Michel', chefServiceEmail: 'michel.chef@example.com', departement: 'Département B', chefDepartementNom: 'Directeur B', chefDepartementPrenom: 'Sophie', chefDepartementEmail: 'sophie.directeur@example.com', pension: 'Non', tel: '9876543210', batiment: 'Tour B', etage: '2', batimentNL: 'Building B' },
...
const Membre = () => {
  ...
  return (
    <div className="container">
      <Navbar members={filteredRows} /> {/* Passer les données filtrées à votre Navbar */}
      <div style={{ height: 600, width: '95%', backgroundColor: "white", margin: '2rem', borderRadius: "1rem" }}>
        <DataGrid
          rows={filteredRows}
          columns={columns}
          pageSize={5}
